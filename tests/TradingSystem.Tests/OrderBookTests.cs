...
public class OrderBookTests
{
    ...
    public void NoMatch_WhenBookIsEmpty_OrderRests()
    {
        ...
        Order order = new Order(id: 1, side: Side.Buy, symbol: "AAPL", orderType: OrderType.Limit, price: 101m, originalQuantity: 5, createdAt: DateTime.UtcNow);
    ...
    public void FullMatch_ExactQuantity_ProducesOneTrade()
    {
        ...
        Order orderSell = new Order(id: 1, side: Side.Sell, symbol: "AAPL", orderType: OrderType.Limit, price: 99m, originalQuantity: 5, createdAt: DateTime.UtcNow);
    ...
    public void PartialFill_LeavesRemainderResting()
    {
        ...
        Order orderSell = new Order(id: 1, side: Side.Sell, symbol: "AAPL", orderType: OrderType.Limit, price: 101m, originalQuantity: 10, createdAt: DateTime.UtcNow);
        orderBookService.Submit(orderSell);
        Order orderBuy = new Order(id: 2, side: Side.Buy, symbol: "AAPL", orderType: OrderType.Limit, price: 101m, originalQuantity: 4, createdAt: DateTime.UtcNow);
    ...
    public void SamePrice_OlderOrderTradesFirst()
    {
        ...
        orderBookServiceV2.Submit(new Order(id: 1, side: Side.Sell, symbol: "AAPL", orderType: OrderType.Limit, price: 101m, originalQuantity: 5, createdAt: DateTime.UtcNow));
        orderBookServiceV2.Submit(new Order(id: 2, side: Side.Sell, symbol: "AAPL", orderType: OrderType.Limit, price: 101m, originalQuantity: 10, createdAt: DateTime.UtcNow));
        Order orderBuy = new Order(id: 3, side: Side.Buy, symbol: "AAPL", orderType: OrderType.Limit, price: 101m, originalQuantity: 5, createdAt: DateTime.UtcNow);
    ...
    public void OrderWalksMultiplePriceLevels()
    {
        ...
        orderBookService.Submit(new Order(id: 2, side: Side.Sell, symbol: "AAPL", orderType: OrderType.Limit, price: 101m, originalQuantity: 10, createdAt: DateTime.UtcNow));
        Order orderBuy = new Order(id: 3, side: Side.Buy, symbol: "AAPL", orderType: OrderType.Limit, price: 101m, originalQuantity: 8, createdAt: DateTime.UtcNow);
    ...
    public void NonCrossingOrders_BothRest_NoTrades()
    {
        ...
        orderBookService.Submit(new Order(id: 1, side: Side.Sell, symbol: "AAPL", orderType: OrderType.Limit, price: 101m, originalQuantity: 5, createdAt: DateTime.UtcNow));
        Order orderBuy = new Order(id: 2, side: Side.Buy, symbol: "AAPL", orderType: OrderType.Limit, price: 99m, originalQuantity: 8, createdAt: DateTime.UtcNow);
    ...
    public void Cancel_RemovesRestingOrder()
    {
        ...
        orderBookService.Submit(new Order(id: 1, side: Side.Buy, symbol: "AAPL", orderType: OrderType.Limit, price: 101m, originalQuantity: 5, createdAt: DateTime.UtcNow));
    ...
    public void GetDepth_AggregatesAndOrdersLevelsCorrectly()
    {
        ...
        orderBookService.Submit(new Order(id: 1, side: Side.Sell, symbol: "AAPL", orderType: OrderType.Limit, price: 102m, originalQuantity: 5, createdAt: DateTime.UtcNow));
        orderBookService.Submit(new Order(id: 2, side: Side.Sell, symbol: "AAPL", orderType: OrderType.Limit, price: 101m, originalQuantity: 10, createdAt: DateTime.UtcNow));
        orderBookService.Submit(new Order(id: 3, side: Side.Sell, symbol: "AAPL", orderType: OrderType.Limit, price: 101m, originalQuantity: 5, createdAt: DateTime.UtcNow));

        orderBookService.Submit(new Order(id: 7, side: Side.Buy, symbol: "AAPL", orderType: OrderType.Limit, price: 99m, originalQuantity: 5, createdAt: DateTime.UtcNow));
        orderBookService.Submit(new Order(id: 9, side: Side.Buy, symbol: "AAPL", orderType: OrderType.Limit, price: 98m, originalQuantity: 10, createdAt: DateTime.UtcNow));
